...
startMonth.innerHTML = stamp.startOf("month").format("MM DD, yyyy h:ii:ss x");
endMonth.innerHTML = stamp.endOf("month").format("MM DD, yyyy h:ii:ss x");
stamp = timestamp();
startDay.innerHTML = stamp.startOf("day").format("MM DD, yyyy h:ii:ss x");
endDay.innerHTML = stamp.endOf("day").format("MM DD, yyyy h:ii:ss x");
stamp = timestamp();
startYear.innerHTML = stamp.startOf("year").format("MM DD, yyyy h:ii:ss x");
endYear.innerHTML = stamp.endOf("year").format("MM DD, yyyy h:ii:ss x");